      ...
      <div style={S.body}>
        ...
        {bookTab==="bookings"&&(
          <>
            ...
            <div style={S.card}>
              {t1Filtered.length===0?(<div style={{ textAlign:"center",color:"#555a7a",padding:"60px 0",fontSize:13 }}><div style={{ marginBottom:10,fontFamily:"'Inter',sans-serif",fontWeight:700,fontSize:15,color:"#94a3b8" }}>{bookingRows.length===0?(selectedDate?"No bookings for this date":"No bookings for today or tomorrow"):"No results for selected filters"}</div></div>):(
                <>
        ...
        {bookTab==="assessments"&&(
          <>
            ...
            <div style={S.card}>
              {t2Filtered.length===0?(<div style={{ textAlign:"center",color:"#555a7a",padding:"60px 0" }}><div style={{ fontFamily:"'Inter',sans-serif",fontWeight:700,fontSize:15,color:"#94a3b8",marginBottom:10 }}>{examSessions.length===0?(selectedDate?"No sessions for this date":"No sessions for today or tomorrow"):"No results"}</div></div>):(
                <>
                  <div style={{ overflowX:"auto" }}>
