...
export default function App() {
  ...
  const S = {
    ...
    body: { padding: "40px 48px", maxWidth: 1100, margin: "0 auto" },
    card: {
      background: "#13141e",
  ...
  return (
    <div style={S.root}>
      ...
      <div style={S.header}>
        ...
        <div style={{ marginLeft: "auto", paddingBottom: 16, fontSize: 12, color: "#555a7a" }}>
          ...
          <div style={{ animation: "fadeIn 0.2s ease" }}>
            ...
            <div style={{ ...S.card, background: "#0d0e14", border: "1px solid #2e3044", padding: "20px 24px" }}>
              <div style={{ fontSize: 12, color: "#555a7a", lineHeight: 1.8 }}>
                <strong style={{ color: "#7eb8ff" }}>Note:</strong> Removing a skill or level does not delete assessments already stored under them. Those will still appear in the manage view. To clean up, delete them individually from the Assessments tab.
              </div>
            </div>
          </div>
        )}
